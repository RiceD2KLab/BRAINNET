...
class MaskFormerEvaluation():
    ...
    def __init__(self, use_brats_region=False):
        ...
        Args:
            use_brats_region (bool): flag indicating whether to use BRATS challenge
            segmentation labels (TC, WT, ET), or native data segmentation labels
            (NCR, ET, ED, ELSE)
        """
    ...
    def predict_and_eval(self, subj_names: List[str], mf_inference: MaskFormerInference, data_handler: DataHandler,
        ...
        Args:
           ...
           mf_inference (MaskFormerInference): instance of MaskFormerInference (train/val/test)
           data_handler (DataHandler): instance of DataHandler (train/val/test)
